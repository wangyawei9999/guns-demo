...
public class ConstantFactory implements IConstantFactory {
    ...
    private BookTableMapper bookTableMapper = SpringContextHolder.getBean(BookTableMapper.class);
    ...
    public String getBookPrice(Integer id) {
        BookTable bookTable = bookTableMapper.selectById(id);
        if (bookTable != null) {
            return bookTable.getBookPrice().toString();
        } else {
            return "No BookPrice";
        }
    }
